...
INSERT INTO `usuario` (`id`, `nombre`, `apellidos`, `email`, `username`, `rol_id`, `password`, `enabled`, `inalterable`, `premium`, `telefono`) VALUES (2, 'vendedor',   'Vendedor',       'maria@sincorreo.com',    'vendedor', 2, '$2a$10$JdTDI22BygL/kxl4jR4zGeeLAhU2xafTlZrtfWki/4xm5TXg5qc.q', 1, 0, 1, '987654654');
INSERT INTO `usuario` (`id`, `nombre`, `apellidos`, `email`, `username`, `rol_id`, `password`, `enabled`, `inalterable`, `premium`, `telefono`) VALUES (3, 'cliente',    'Cliente',        'pepe@sincorreo.com',     'cliente',  2, '$2a$10$JdTDI22BygL/kxl4jR4zGeeLAhU2xafTlZrtfWki/4xm5TXg5qc.q', 1, 0, 0, '879654456');
...
INSERT INTO `anuncio` (`id`, `titulo`, `descripcion`, `precio`, `fecha_publicacion`, `vendedor_id`, `activo`, `reservado`, `vendido`, `banos`, `habitaciones`, `superficie`, `direccion`, `visto`) VALUES (1, 'Apartamento de lujo', 'Apartamento centrico con piscina', 450000, '2022-02-28', 2, 1, 0, 0, 2, 4, 300, 'Calle Nueva, Jaen', 0);
INSERT INTO `anuncio` (`id`, `titulo`, `descripcion`, `precio`, `fecha_publicacion`, `vendedor_id`, `activo`, `reservado`, `vendido`, `banos`, `habitaciones`, `superficie`, `direccion`, `visto`) VALUES (2, 'Piso de oficina', 'Piso en el centro de la ciudad con vista al mar', 250000, '2022-02-28', 2, 1, 0, 0, 1, 2, 110, 'Calle Principal, Jaen', 0);
INSERT INTO `anuncio` (`id`, `titulo`, `descripcion`, `precio`, `fecha_publicacion`, `vendedor_id`, `activo`, `reservado`, `vendido`, `banos`, `habitaciones`, `superficie`, `direccion`, `visto`) VALUES (3, 'Casa en la playa', 'Hermosa casa con vista al mar', 300000, '2024-11-22', 3, 1, 0, 0, 3, 5, 200, 'Paseo de la Estacion, Jaen', 0); 
